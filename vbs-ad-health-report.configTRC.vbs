...
'###################################################
	...
	usingOU = True
	oDC = Array("STKDOM096","STKDOM02","SMFDOM03","AZE-DCS01","AZE-DCS02","AZE-DCS03","AZE-DCS04" ) 'Ignored if usingOU is True
	...
	attachCSV = False 'Attach a CSV version of the replication report/summary
	
	saveReport = True 'Save a file with the report summary
	pathReportOutput = "c:\ AD Health\AD-health-summary.html" 'Path and name for the output file
	
	'E-mail settings, edit by your own
	emailSubject = "Active Directory Health Summary"
	emailFrom = "ADHealth@pletter.com"
	emailTo = "ITServices@pletter.com"
	emailCc = "" 
	emailPort = 25
	emailAuth = 0	
	emailSenderUser = ""
	emailSenderPassword = ""
	emailServer = "Intmail.trsecure.com"
	emailSSL = False
